 ...
 *
 */
public class SimulabCopyAction extends SelectionListenerAction {
     ...
     */
    public SimulabCopyAction(Shell shell, Clipboard clipboard) {
     ...
     * @since 2.0
     */
    public SimulabCopyAction(Shell shell, Clipboard clipboard, SimulabPasteAction pasteAction) {
